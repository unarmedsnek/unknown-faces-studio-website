export default {
  ...
  booking: {
    ...
    modal: {
      ...
      addExtraHour: "Add an extra hour (+10€)",
    ...
    extraServices: {
      ...
      instrumental: "Instrumental (Exclusive, Custom) Lease (+150€)",
