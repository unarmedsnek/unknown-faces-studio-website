export default {
  ...
  booking: {
    ...
    modal: {
      ...
      addExtraHour: "Pridėk papildomą valandą (+10€)",
      ...
      rulesAgreement: "Aš perskaičiau ir sutinku su",
